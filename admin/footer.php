  ...
  <footer class="main-footer">
    ...
    Copyright &copy; 2014-2016 <strong>GAD Flavio Alfaro.</strong> All rights
    reserved.
  </footer>
...
<!-- Morris.js charts -->
<script src="../lib/AdminLTE/bower_components/raphael/raphael.min.js"></script>
<script src="../lib/AdminLTE/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
<script src="../lib/AdminLTE/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
...
<!-- jQuery Klib/AdminLTE/nob Chart -->
<script src="../lib/AdminLTE/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
<script src="../lib/AdminLTE/bower_components/moment/min/moment.min.js"></script>
<script src="../lib/AdminLTE/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
<!-- datepicker -->
<script src="../lib/AdminLTE/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
<!-- Select2 -->

...
<!-- Bootstrap 3.3.7 -->
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="../lib/AdminLTE/bower_components/morris.js/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="../lib/AdminLTE/bower_components/jvectormap/jquery-jvectormap.css">
  <!-- Date Picker -->
  <link rel="stylesheet" href="../lib/AdminLTE/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
  <!-- Daterange picker -->
  ...
  <link href="../lib/alertifyjs/css/alertify.css" rel="stylesheet" type="text/css"/>
  <link href="../lib/alertifyjs/css/themes/default.css" rel="stylesheet" type="text/css"/>
  <script src="../lib/jquery-3.2.1.min.js"></script>
  <script src="../js/funciones.js"></script>
  <script src="../js/funciones_admin.js"></script>
  <script src="../js/funciones_equipos.js"></script>
  <script src="../js/funciones_user.js"></script>
  <script src="../js/funciones_tecnico.js"></script>

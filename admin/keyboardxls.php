...
<table width="60%" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>
	             ...
	             <?php
                   ...
                   $sql = "SELECT keyboard.KEY_CODIGO,estados.EST_DETALLE,keyboard.KEY_MARCA,keyboard.KEY_MODELO,keyboard.KEY_SERIE,keyboard.KEY_OBSERVACION FROM keyboard INNER JOIN estados ON keyboard.EST_CODIGO = estados.EST_CODIGO WHERE KEY_MARCA NOT IN('NINGUNO',' ')";       
              ?>

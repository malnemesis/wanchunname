...
<!-- Modal para edición impresora-->
   ...
   <div class="modal fade" id="modalEdicion">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Editar Impresora</h4>
              </div>
              <div class="modal-body">
                    <div class="modal-body">

      <input type="text" hidden="" id="IMP_CODIGO">
      <form>
    ...
    <label>Estado</label>
          ...
          <div class="form-group col-md-6">
            <label>Marca</label>
            <input type="text" class="form-control" id="IMP_MARCAU">
          </div>
          </div>
          <div class="row">
          <div class="form-group col-md-6">
            <label>Modelo</label>
            <input type="text" class="form-control" id="IMP_MODELOU">
          </div>
          <div class="form-group col-md-6">
            <label>Serie</label>
            <input type="text" class="form-control" id="IMP_SERIEU">
          </div>
          </div>
          <div class="row">
          <div class="form-group col-md-6">
            <label>Consumible</label>
            <input type="text" class="form-control" id="IMP_CONSUMIBLESU">
          </div>
          <div class="form-group col-md-6">
                <label>Conectividad</label>
                <select class="form-control" id="IMP_CONECTIVIDADU">
                  <option>SI</option>
                  <option>NO</option>
                </select>
          </div>
          <div class="form-group col-md-6">
            <label>Código de Activo Fijo</label>
            <input type="text" class="form-control" id="IMP_CODACTFIJU">
          </div>
          </div>
          <div class="form-group">
            <label>Observación</label>
            <input type="text" class="form-control" id="IMP_OBSERVACIONU">
          </div>
        </form>
      ...
      <div class="modal-footer">
         <button class="btn" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i> <strong>Cerrar</strong></button>                
        <button type="button" class="btn btn-primary" data-dismiss="modal" id="actualizaimp">Actualizar Impresora</button>
      </div>
    </div>
  </div>
</div>
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header">
                ...
                <a href="impresorapdf.php"><button class="btn btn-danger" title="PDF">
...
$(document).ready(function(){
      var consulta;
      $("#IMP_CODACTFIJ").focus();
      $("#IMP_CODACTFIJ").keyup(function(e){
             consulta = $("#IMP_CODACTFIJ").val();
                        $.ajax({
                              type: "POST",
                              url: "../admin/action/vcodaf.php",
                              data: "IMP_CODACTFIJ="+consulta,
                              dataType: "html",
                              error: function(){
                                    alert("error petición ajax");
                              },

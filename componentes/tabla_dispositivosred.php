...
?>
             ...
             ?>
                <tr>
                  <td><a class="btn btn-info" data-toggle="modal" data-target="#modalEdicion" onclick="agregarformdr('<?php echo $datosdr?>')" role="button"><i class="fa fa-fw fa-pencil" aria-hidden="true" title="EDITAR"></i></a></td>
                  <td><?php echo $dr[0]?></td>
                  <td><?php echo $dr[1]?></td>
                  <td><?php echo $dr[2]?></td>
                  <td><?php echo $dr[3]?></td>
